...
export function GlobeDemo() {
  ...
  const polygonColor = useColorModeValue(
    'rgba(0,0,0,0.9)',
  ...
  useEffect(() => {
    ...
    const raf = requestAnimationFrame(() => setIsMobile(checkIfMobile()));
  ...
  const sampleArcs = sampleArcDefinitions.map((arc, i) => ({
    ...arc,
  ...
  return (
    <div
      style={{
        display: 'flex',
        flexDirection: 'column', // Assuming you want elements stacked vertically
        alignItems: 'center',
        ...
        position: 'relative' // For positioning the gradient and globe
      }}
    >
      <div
        style={{
