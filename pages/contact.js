import { Box, Heading, Text, Input, Textarea, Button, chakra } from "@chakra-ui/react";
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="mt-10 flex flex-col">
        ...
        <Button
            ...
            gap="2"
            >
                Submit <ChakraPaperPlane boxSize="3" opacity="0.7" transition="all 0.2s" _groupHover={{ transform: "translate(1px, -1px)" }} />
        </Button>
      </form>
    </motion.section>
  );
