...
import { Container, Heading, Box, Button, List, ListItem, ListIcon, Image } from '@chakra-ui/react';
...
const About = () => {
    return (
        <Layout title="About">
            <Section delay={0.1} mb={{ base: 16, md: 24 }}>  
                <Container>
                    <Heading
                        as="h3"
            ...
            <Box
                ...
                mb={{ base: 32, md: 40 }}  // Increase bottom margin for divider
                h="16"
                w="1"
                rounded="full"
            ...
            ></Box>
            <br/> <br/>
            <Section delay={0.1} position="relative" mb={{ base: 16, md: 24 }}>  {/* Add margin-bottom for mobile and desktop */}
                <Box>
                    <Image
                        ...
                        float="left"
                        mr={4}
                        mb={{ base: 8, md: 12 }}  // Increase bottom margin for image
                    />
                </Box>
                <Box>
                    <Heading as="h3" variant="section-title" textAlign="center" mb={{ base: 8, md: 12 }}>  {/* Increase bottom margin for heading */}
                        More...
                    </Heading>
                    <Paragraph mb={{ base: 0, md: 12 }}>  
                    ...
                    <Box align="center" my={{ base: 8, md: 12 }}>  {/* Increase margin for button */}
                        <Button
                            as={NextLink}
                            href="/works"
                            scroll={false}
            ...
            <Section delay={0.3} mb={{ base: 12, md: 24 }}> 
                <Heading
                    as="h3"
                    variant="section-title"
                    textAlign="center"
